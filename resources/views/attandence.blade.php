  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav  nav nav-tabs">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="{{url('/attandence')}}">Attandence</a>
        </li>
      </ul>
    </div>
   </div>
...
<form action="{{url('/StudentAttandence')}}" method="post" class="form">
    @csrf
    <div class="mb-3">
  ...
  <div class="btn-toolbar justify-content-between">
    ...
    <a href="{{'/StudentAttandence/view'}}"  class="btn btn-success m-3">ViewTable</a>
  </div>
...
<form action="{{url('/ClassAttandence/view')}}" method="get" class="form">
    @csrf
    <div class="mb-3">
        <label for="className" class="form-label m-2">Class Name:</label><br>
        <select name="className" class="form-select" id="className" required>
